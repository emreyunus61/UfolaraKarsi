...
//mermi interface ile gameobject sınıfından türetildi ve playscreen sınıfında nesneyle  üretildi.
...
public class mermi implements gameobject {
    ...
    public void render(SpriteBatch sb) {
        sb.begin();
        sb.draw(com.isgal.isgaldensavun.imageloader.imageLoader.kursunReg,position.x,position.y,size.x,size.y);
        sb.end();
    }
