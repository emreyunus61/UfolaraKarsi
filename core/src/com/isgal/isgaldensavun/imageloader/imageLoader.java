package com.isgal.isgaldensavun.imageloader;
...
//Kullanılan resimler kordinatlarına göre bu sınıfda tanımlanıyor.
...
public class imageLoader {
    ...
    public static Sound sesKursun,sesGameOver;
    ...
    public static void Load() {
        ...
        sesKursun = Gdx.audio.newSound(Gdx.files.internal("sesKursun.mp3"));
        sesGameOver = Gdx.audio.newSound(Gdx.files.internal("sesGameOver.mp3"));
